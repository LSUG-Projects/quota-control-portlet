...
/**
 * The base implementation of the quota local service.
 *
 * <p>
...
public abstract class QuotaLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Quota updateQuota(Quota quota, boolean merge)
		throws SystemException {
		quota.setNew(false);

		return quotaPersistence.update(quota, merge);
	}
