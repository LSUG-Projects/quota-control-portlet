...
import org.lsug.NoSuchQuotaException;

import org.lsug.model.Quota;
import org.lsug.model.impl.QuotaImpl;
import org.lsug.model.impl.QuotaModelImpl;
...
public class QuotaPersistenceImpl extends BasePersistenceImpl<Quota>
	 ...
	 */
	public Quota create(long qoutaId) {
		Quota quota = new QuotaImpl();

		quota.setNew(true);
		quota.setPrimaryKey(qoutaId);
	 ...
	 */
	public Quota remove(long qoutaId)
		throws NoSuchQuotaException, SystemException {
		return remove(Long.valueOf(qoutaId));
	}
	...
	@Override
	public Quota updateImpl(org.lsug.model.Quota quota, boolean merge)
	...
	protected Quota toUnwrappedModel(Quota quota) {
		...
		quotaImpl.setQoutaId(quota.getQoutaId());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Quota findByPrimaryKey(long qoutaId)
		throws NoSuchQuotaException, SystemException {
		Quota quota = fetchByPrimaryKey(qoutaId);

		if (quota == null) {
			if (_log.isWarnEnabled()) {
				_log.warn(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY + qoutaId);
			}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Quota fetchByPrimaryKey(long qoutaId) throws SystemException {
		Quota quota = (Quota)EntityCacheUtil.getResult(QuotaModelImpl.ENTITY_CACHE_ENABLED,
				QuotaImpl.class, qoutaId);
		...
		if (quota == null) {
			...
			try {
				...
				if (quota != null) {
					...
					EntityCacheUtil.putResult(QuotaModelImpl.ENTITY_CACHE_ENABLED,
						QuotaImpl.class, qoutaId, _nullQuota);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.org.lsug.model.Quota")));
