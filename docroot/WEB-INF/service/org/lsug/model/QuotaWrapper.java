...
public class QuotaWrapper implements Quota, ModelWrapper<Quota> {
	...
	*/
	...
	/**
	* Returns the qouta ID of this quota.
	*
	* @return the qouta ID of this quota
	*/
	public long getQoutaId() {
		return _quota.getQoutaId();
	}

	/**
	* Sets the qouta ID of this quota.
	*
	* @param qoutaId the qouta ID of this quota
	*/
	public void setQoutaId(long qoutaId) {
		_quota.setQoutaId(qoutaId);
	}
	...
	*/
	...
	public int compareTo(org.lsug.model.Quota quota) {
	...
	public com.liferay.portal.model.CacheModel<org.lsug.model.Quota> toCacheModel() {
		return _quota.toCacheModel();
	}

	public org.lsug.model.Quota toEscapedModel() {
