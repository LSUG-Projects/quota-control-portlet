...
public class SitesConfigurationQuotaPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return PortletKeys.SiteConfigurationQuotaWeb;
	}

	@Override
	@Reference(target = "(javax.portlet.name=" + PortletKeys.SiteConfigurationQuotaWeb + ")", unbind = "-")
