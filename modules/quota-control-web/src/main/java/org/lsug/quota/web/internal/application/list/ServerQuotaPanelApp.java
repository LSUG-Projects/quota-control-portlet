...
public class ServerQuotaPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return PortletKeys.ServerQuotaWeb;
	}

	@Override
	@Reference(target = "(javax.portlet.name=" + PortletKeys.ServerQuotaWeb + ")", unbind = "-")
