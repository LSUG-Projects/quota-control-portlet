...
public class SiteQuotaPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return PortletKeys.SitesQuotaWeb;
	}

	@Override
	@Reference(target = "(javax.portlet.name=" + PortletKeys.SitesQuotaWeb + ")", unbind = "-")
