...
public class QuotaUploadImageMVCActionCommand extends BaseMVCActionCommand {
	...
	protected void activate(BundleContext bundleContext, Map<String, Object> properties) {
		...
		_serviceTrackerFileEntryHandler = new ServiceTracker<>(
				bundleContext,
				"com.liferay.blogs.web.internal.upload.ImageBlogsUploadFileEntryHandler", 
								...
								new ServiceTracker<>(bundleContext, 
									...
									new ServiceTrackerCustomizer<Object, ServiceRegistration<?>>() {
										...
										public ServiceRegistration<?> addingService(
											...
											_imageBlogsUploadFileEntryHandler = _localUploadFileEntryHandler;
											return bundleContext.registerService(
													MVCActionCommand.class,
													QuotaUploadImageMVCActionCommand.this,
										...
										public void removedService(ServiceReference<Object> reference,
											 ...
											 service.unregister();											
											_imageBlogsUploadFileEntryHandler = null;
	...
	private UploadFileEntryHandler _imageBlogsUploadFileEntryHandler;	
